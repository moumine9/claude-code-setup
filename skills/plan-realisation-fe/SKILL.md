...
- Si un numéro de ticket est fourni dans `$ARGUMENTS` (ex: `PV2-12345`), utilise-le.
...
Chaque point est une étape actionnable. Tu peux mentionner des noms de fichiers si ça aide à la compréhension mais reste concis. Pas de code, pas de détail d'implémentation.
