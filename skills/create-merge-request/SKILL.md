...
- "Travail effectué" should be a bulleted list derived from the commits and diff. Include always the fix, features created. In last include the improvements, code-refactoring.
